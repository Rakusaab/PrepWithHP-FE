    ...
    <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex overflow-hidden">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-gray-600 text-sm">Sign in to continue your exam preparation journey</p>
            </div>
          </div>
          ...
          <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              ...
              {/* Social Login - Primary Option */}
              <div className="space-y-3">
                <p className="text-sm font-medium text-gray-700 text-center">Quick Sign In</p>
              ...
              {/* Minimal Email Form */}
              <div className="space-y-3">
                <p className="text-sm font-medium text-gray-700 text-center">Sign in with Email</p>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-primary-600 to-primary-800 text-white p-8 lg:p-12 items-center">
        <div className="max-w-md">
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4">Join thousands of successful candidates</h2>
            <p className="text-primary-100 text-lg leading-relaxed">
              Prepare for HPSSC, HPPSC, Police, and Banking exams with our AI-powered platform designed specifically for Himachal Pradesh government exams.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-primary-100 text-sm">Get personalized study plans and instant feedback with our advanced AI technology.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">Comprehensive Materials</h3>
                <p className="text-primary-100 text-sm">Access complete study materials for all major Himachal Pradesh government exams.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-primary-100 text-sm">Join a community of thousands of aspirants and successful candidates.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-primary-500/30">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-sm">
                ...
                <p className="text-primary-200">from 2,500+ students</p>
              </div>
            </div>
          </div>
        </div>
